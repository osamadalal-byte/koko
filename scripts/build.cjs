...
const assets=['index.html','coach-engine.js','demos.js','personal.js','guidance.js','coach.js','phone.js','release.js','experience.js','experience.css','coach.css','service-worker.js','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
...
html=html.replace(/<link rel="stylesheet" href="(coach|experience)\.css">/g,(_,name)=>'<style>\n'+fs.readFileSync(path.join(root,name+'.css'),'utf8')+'\n</style>');
