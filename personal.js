...
Object.assign(EX,{
  ...
  cheststretch:{name:'Gentle chest stretch',area:'Cool-down · chest · shoulders',cue:'Gently open the front of your chest. Hold without bouncing, then release.',steps:['Stand tall with hands resting lightly at the back of your hips.','Bring your elbows a little closer behind you until you feel a mild stretch across the chest.','Hold comfortably for 15–20 seconds while breathing, then release and repeat if time remains.'],easy:'Use less movement. Avoid pushing your lower back into an arch.',pose:'stand'},
  calfhold:{name:'Standing calf stretch',area:'Cool-down · calves · ankles',cue:'One foot back, heel grounded. Lean gently forward and switch sides halfway.',steps:['Face a solid wall and rest your hands on it. Step one foot back.','Keep the back heel down and the back leg comfortably straight as you bend the front knee slightly.','Hold a mild stretch and breathe. Switch legs halfway through the interval.'],easy:'Shorten the stance and lean less.',pose:'stand'},
